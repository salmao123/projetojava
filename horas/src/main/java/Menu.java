...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuAlterarSenha.setText("Mudar Senha");
        menuNovo.add(menuAlterarSenha);

        menuExcluir.setText("Excluir");
        menuNovo.add(menuExcluir);
    ...
    private void acaoSair(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_acaoSair
        Login login = new Login();
    login.setVisible(true);
    dispose();
    }//GEN-LAST:event_acaoSair

    private void acaoUsuario(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_acaoUsuario
        CadastroUsuario cadastroUsuario = new CadastroUsuario();
        cadastroUsuario.setVisible(true);
    }//GEN-LAST:event_acaoUsuario
